...
const Collection = () => {
  ...
  useEffect(() => {
    document.title = cmsCollection?.seoTitle || `${collection.title} | Amelie Milano`;
  ...
  }, [cmsCollection?.seoDescription, cmsCollection?.seoTitle, collection.copy, collection.title]);
