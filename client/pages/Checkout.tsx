...
const Checkout = () => {
  ...
  const [delivery, setDelivery] = useState<"regular" | "express" | "store">("regular");
  ...
  const shipping = delivery === "express" ? 200 : delivery === "store" || subtotal >= 3000 ? 0 : 150;
