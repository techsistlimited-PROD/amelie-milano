  ...
  <div className="min-h-screen bg-ivory">
    ...
    <main>
      <section className="relative min-h-[620px] md:h-[700px] overflow-hidden bg-stone-900 flex items-end">
        <img src="https://cdn.builder.io/api/v1/image/assets%2F661d1ac868bc41caba3d7f46cd61e3ce%2F87192a4e5d0949b8b89c181ebaa5ef28?format=webp&width=1600&height=2000" alt="Amelie Milano Occasionwear" className="absolute inset-0 w-full h-full object-cover object-center" />
