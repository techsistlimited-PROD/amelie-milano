  ...
  return (
    <article className="group">
      <div className="relative overflow-hidden bg-beige/30 mb-4">
        ...
        <button type="button" aria-label={`${wishlisted ? "Remove" : "Add"} ${product.name} ${wishlisted ? "from" : "to"} wishlist`} onClick={toggle} className="absolute top-3 right-3 rounded-full bg-white/90 p-2 text-stone-700 hover:text-teal transition-colors"><Heart size={16} className={wishlisted ? "fill-teal text-teal" : ""} /></button>
