  ...
  return (
    <div className="min-h-screen bg-[#F9F5F0] text-stone-900">
      ...
      <main>
        ...
        <section className="bg-[#F3E9DE] py-16 text-center"><div className="container mx-auto max-w-2xl px-4"><p className="mb-3 text-[10px] uppercase tracking-[0.24em] text-[#0057B8]">Stay close to Amelie</p><h2 className="font-serif text-4xl md:text-5xl">A note from our world to yours.</h2><p className="mt-4 text-sm leading-7 text-stone-600">Be the first to discover new collections, private edits, and considered stories from Milano to Dhaka.</p><NewsletterForm className="mx-auto mt-7 flex max-w-md border-b border-stone-500" inputClassName="min-w-0 flex-1 bg-transparent px-1 py-3 text-sm outline-none placeholder:text-stone-500" buttonClassName="px-2 text-xs uppercase tracking-[0.14em] text-teal hover:text-[#C69B6D]" /></div></section>
      </main>
      <Footer />
