...
const GymProduct = ({ product }: { product: (typeof gymProducts)[number] }) => {
  const { saved, toggle } = useWishlist({ id: product.id, name: product.name, price: product.price, image: product.image, category: "Gym Wear", colour: "Signature colour", option: "M" });
